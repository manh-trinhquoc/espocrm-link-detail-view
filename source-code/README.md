...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/LinkDetailView
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/LinkDetailView)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/LinkDetailView`
* `site/tests/integration/Espo/Modules/LinkDetailView`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/LinkDetailView/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/LinkDetailView/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/link-detail-view/lib/init.js"
        ]
    }
    ```
